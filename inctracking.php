...
if(@$_REQUEST['carrier']!='')
	...
	if(@$_REQUEST['trackno']!=''){
		...
		if(preg_match('/^((\d{30})|(9\d{21})|(82\d{8})|((CJ|CP|EA|EO|EC|RA)\d{9}US))$/', $trackno)>0)
			$theshiptype='usps';
		...
		<tr>
		  <td class="cobll" colspan="2">
			<table border="0" cellspacing="0" cellpadding="0" width="100%">
			  <tr>
				<td width="40"><img src="images/upslogo.png" alt="UPS" /></td><td align="center">&nbsp;<br /><span style="font-size:18px;font-family:Verdana;font-weight:bold">UPS OnLine Tools&reg; Tracking</span><br />&nbsp;</td><td width="40">&nbsp;</td>
			  </tr>
			</table>
		  </td>
		</tr>
...
?>
			  ...
			  <tr>
			    <td class="cobll" colspan="2" align="center"><?php print imageorbutton(@$imgviewlicense,'View License','','viewlicense()',TRUE).' '.imageorbutton(@$imgtrackpackage,'Track Package','','checkaccept()',TRUE)?></td>
			  </tr>
			  <tr>
...
?>
			  ...
			  <tr>
			    <td class="cobll" colspan="2" align="center"><?php print imageorsubmit(@$imgtrackpackage,'Track Package','')?></td>
			  </tr>
			</table>
	  <table border="0" cellspacing="0" cellpadding="0" width="100%" align="center">
        <tr>
