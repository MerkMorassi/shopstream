...
if(@$_POST["posted"]=="1"){
	...
	$sSQL .= ",adminlang='" . @$_POST['adminlang'] . "'";
	$sSQL .= ",storelang='" . @$_POST['storelang'] . "'";
...
<tbody>
<tr><td colspan="2">Which languages do you wish to use</td></tr>
<tr>
...
<td><select name="storelang" size="1">
		<option value="">English</option>
		<option value="dk" <?php if($rsAdmin['storelang']=='dk') print 'selected="selected"'?>>Danish / Dansk</option>
		<option value="fr" <?php if($rsAdmin['storelang']=='fr') print 'selected="selected"'?>>French / Fran&ccedil;ais</option>
		<option value="de" <?php if($rsAdmin['storelang']=='de') print 'selected="selected"'?>>German / Deutsch</option>
		<option value="it" <?php if($rsAdmin['storelang']=='it') print 'selected="selected"'?>>Italian / Italiano</option>
		<option value="nl" <?php if($rsAdmin['storelang']=='nl') print 'selected="selected"'?>>Nederlands / Dutch</option>
		<option value="pt" <?php if($rsAdmin['storelang']=='pt') print 'selected="selected"'?>>Portugese / Portugu&ecirc;s</option>
		<option value="es" <?php if($rsAdmin['storelang']=='es') print 'selected="selected"'?>>Spanish / Espa&ntilde;ol</option>
		</select></td>
</tr>
