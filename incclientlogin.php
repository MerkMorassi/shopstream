...
function deleteaddress(theid){
	if(confirm("<?php print jscheck($xxDelAdd)?>")){
...
if(document.forms.mainform.listname.value==''){
	alert("<?php print jscheck($xxPlsEntr . ' "' . $xxLisNam)?>\".");
...
function deletelist(theid){
	if(confirm("<?php print jscheck($xxDelLis)?>")){
...
if(frm.newpw.value==""){
	alert("<?php print jscheck($xxPlsEntr . ' "' . $xxNewPwd)?>\".");
	frm.newpw.focus();
	return(false);
}
...
if(newpw!=newpw2){
	alert("<?php print jscheck($xxPwdMat)?>");
	frm.newpw.focus();
	return(false);
}
return true;
...
if(frm.email.value==""){
	alert("<?php print jscheck($xxPlsEntr . ' "' . $xxEmail)?>\".");
	frm.email.focus();
	return (false);
}
var regex = /[^@]+@[^@]+\.[a-z]{2,}$/i;
...
<?php	}elseif(@$_POST['action']=='editaddress' || @$_POST['action']=='newaddress'){
	...
	<input type="hidden" name="theid" value="<?php print $addID?>" />
	  <table class="cobtbl" width="100%" border="0" cellspacing="1" cellpadding="3">
		...
		<?php	} ?>
		<tr><td align="right" width="40%" class="cobhl"><strong><?php print $redstar . $xxName?>:</strong></td><td class="cobll"><?php
		if(@$usefirstlastname){
			$thestyle='';
		...
		?></td></tr>
		<tr><td align="right" class="cobhl"><strong><?php print $redstar . $xxAddress?>:</strong></td><td class="cobll"><input type="text" name="address" id="address" size="25" value="<?php print htmlspecials($addAddress)?>" /></td></tr>
		...
		<?php	} ?>
		<tr><td align="right" class="cobhl"><strong><?php print $redstar . $xxCity?>:</strong></td><td class="cobll"><input type="text" name="city" id="city" size="20" value="<?php print htmlspecials($addCity)?>" /></td></tr>
		<?php	if($hasstates || $nonhomecountries){ ?>
		<tr><td align="right" class="cobhl"><strong><?php print replace($redstar,'<span','<span id="statestar"')?><span id="statetxt"><?php print $xxState?></span>:</strong></td><td class="cobll"><select name="state" id="state" size="1" onchange="dosavestate('')"><?php $havestate = show_states($addState) ?></select><input type="text" name="state2" id="state2" size="20" value="<?php if(! $havestate) print htmlspecials($addState)?>" /></td></tr>
		<?php	} ?>
		<tr><td align="right" class="cobhl"><strong><?php print $redstar . $xxCountry?>:</strong></td><td class="cobll"><select name="country" id="country" size="1" onchange="checkoutspan('')" ><?php show_countries($addCountry) ?></select></td></tr>
		<tr><td align="right" class="cobhl"><strong><?php print replace($redstar,'<span','<span id="zipstar"') . $xxZip?>:</strong></td><td class="cobll"><input type="text" name="zip" id="zip" size="10" value="<?php print htmlspecials($addZip)?>" /></td></tr>
		<tr><td align="right" class="cobhl"><strong><?php print $redstar . $xxPhone?>:</strong></td><td class="cobll"><input type="text" name="phone" id="phone" size="20" value="<?php print htmlspecials($addPhone)?>" /></td></tr>
...
if(frm.ordextra1.value==""){
	alert("<?php print jscheck($xxPlsEntr . ' "' . $extraorderfield1)?>\".");
	frm.ordextra1.focus();
	return (false);
}
<?php } ?>
...
if(frm.ordextra2.value==""){
	alert("<?php print jscheck($xxPlsEntr . ' "' . $extraorderfield2)?>\".");
	frm.ordextra2.focus();
	return (false);
}
<?php } ?>
